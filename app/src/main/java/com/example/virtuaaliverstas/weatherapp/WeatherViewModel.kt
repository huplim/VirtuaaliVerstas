package com.example.virtuaaliverstas.weatherapp

import android.app.Application
import androidx.lifecycle.AndroidViewModel
import androidx.lifecycle.viewModelScope
import com.example.virtuaaliverstas.getApiKey
import com.example.virtuaaliverstas.getPlace
import com.example.virtuaaliverstas.getUseLocation
...
class WeatherViewModel(application : Application) : AndroidViewModel(application) {
    ...
    fun fetchWeatherDataByPlace(apiKey: String, place: String = "Finland") {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val data = RetrofitInstance.weatherApiService
